...
export default {
    ...
    methods: {
        ...
        async get_event() {
            await ALERT.get_hybridization_alert(this.cow_range, this.region).then((res) => {
                ...
                res.forEach((e, index) => {
                    ...
                    list_items.data.push({
                        ...
                        cow_id: e.cow_id,
                        title: `${e.cow_id}号牛只`,
                        info: `${e.affirm?'已配种':e.specific_date}`,
                        isStar: false,
                        affirm: e.affirm,
                        result: e.affirm,
                        can_input: false,
        ...
        async confirm() {
            ...
            await ALERT.confirm_hybridization(id, this.region).then((res) => {
                this.is_select = false
